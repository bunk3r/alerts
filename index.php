...
<body>
    <div class="siimple-grid background">
        ...
        <div class="siimple-grid-row">
            ...
            <a href='step-16.php' target="_blank">
                <div class="siimple-grid-col siimple-grid-col--2">
                    <div class="siimple-card" style="max-width:300px">
                        <div class="siimple-card-header">
                            Alert Lab 16
        ...
        <div class="siimple-grid-row">
            ...
            <div class="siimple-grid-col siimple-grid-col--3"></div>
            <a href='step-17.php' target="_blank">
                <div class="siimple-grid-col siimple-grid-col--2">
                    <div class="siimple-card" style="max-width:300px">
                        <div class="siimple-card-header">
                            Alert Lab 17
            ...
            <a href='step-18.php' target="_blank">
                <div class="siimple-grid-col siimple-grid-col--2">
                    <div class="siimple-card" style="max-width:300px">
                        <div class="siimple-card-header">
                            Alert Lab 18
            ...
            <a href='step-19.php' target="_blank">
                <div class="siimple-grid-col siimple-grid-col--2">
                    <div class="siimple-card" style="max-width:300px">
                        <div class="siimple-card-header">
                            Alert Lab 19
        ...
        <div class="siimple-grid-row">
            ...
            <div class="siimple-grid-col siimple-grid-col--4"></div>

                        <a href='step-20.php' target="_blank">
                            <div class="siimple-grid-col siimple-grid-col--2">
                                <div class="siimple-card" style="max-width:300px">
                                    <div class="siimple-card-header">
                                        Alert Lab 20
            ...
            <a href='step-21.php' target="_blank">
                <div class="siimple-grid-col siimple-grid-col--2">
                    <div class="siimple-card" style="max-width:300px">
                        <div class="siimple-card-header">
                            Alert Lab 21
